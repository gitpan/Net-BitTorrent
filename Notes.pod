...
=head3 C<Net::BitTorrent::Session::Piece::Block>
...
request a free L<block|Net::BitTorrent::Session::Piece::Block>.  Blocks
are requested in order from the beginning of the piece to the end.
Finally, we re-request any rejected or canceled blocks.
...
C<Net::BitTorrent::Session::_pick_piece()>.
...
=for svn $Id: Notes.pod 28 2008-09-26 22:47:04Z sanko@cpan.org $
