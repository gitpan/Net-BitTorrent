...
SKIP: {
    ...
    is($_ip_address->url,   q[http://127.0.0.1/announce/], q[url is correct]);
    is($_host_address->url, q[http://localhost/announce/], q[url is correct]);
    skip(
...
$Id: HTTP.t 3f42870 2009-02-12 05:01:56Z sanko@cpan.org $
