...
package Net::BitTorrent::Version;
{
    use strict;
    use warnings;
    our $VERSION_BASE = 50; our $UNSTABLE_RELEASE = 50; our $VERSION = sprintf(($UNSTABLE_RELEASE ? q[%.3f_%03d] : q[%.3f]), ($VERSION_BASE / 1000), $UNSTABLE_RELEASE);
...
=for svn $Id: Version.pm 5476ff9 2009-09-07 04:37:45Z sanko@cpan.org $
