...

{
    ...
    BEGIN {
        ...
        use version qw[qv];
        our $SVN
            = q[$Id: Session.pm 7 2008-04-01 23:46:20Z sanko@cpan.org $];
        our $VERSION = sprintf q[%.3f], version->new(qw$Rev: 7 $)->numify / 1000;
    }
    use Digest::SHA qw[];
    use File::Spec qw[];
...
=for svn $Id: Session.pm 7 2008-04-01 23:46:20Z sanko@cpan.org $
