...
use warnings;
{
    ...
    BEGIN {
        ...
        use version qw[qv];
        our $SVN
            = q[$Id: File.pm 6 2008-03-31 21:19:43Z sanko@cpan.org $];
        our $VERSION = sprintf q[%.3f], version->new(qw$Rev: 6 $)->numify / 1000;
    }
...
=for svn $Id: File.pm 6 2008-03-31 21:19:43Z sanko@cpan.org $
