...
use warnings;
{
    ...
    BEGIN {
        use version qw[qv];
        our $SVN = q[$Id: Peer.pm 25 2008-07-02 03:07:52Z sanko@cpan.org $];
        our $VERSION = sprintf q[%.3f], version->new(qw$Rev: 25 $)->numify / 1000;
    }
    use Socket
...
=for svn $Id: Peer.pm 25 2008-07-02 03:07:52Z sanko@cpan.org $
