...
package Net::BitTorrent::Torrent;
{
    ...
    *import = *import = *Exporter::import;
    ...
    use version qw[qv];
    our $SVN = q[$Id: Torrent.pm 49 2009-01-05 22:38:02Z sanko@cpan.org $];
    our $UNSTABLE_RELEASE = 3; our $VERSION = sprintf(($UNSTABLE_RELEASE ? q[%.3f_%03d] : q[%.3f]), (version->new((qw$Rev: 49 $)[1])->numify / 1000), $UNSTABLE_RELEASE);
    my %REGISTRY = ();
...
=for svn $Id: Torrent.pm 49 2009-01-05 22:38:02Z sanko@cpan.org $
