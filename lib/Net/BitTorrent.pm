...
use warnings;
{
    ...
    BEGIN {
        ...
        use version qw[qv];
        our $SVN
            = q[$Id: BitTorrent.pm 8 2008-04-01 23:53:38Z sanko@cpan.org $];
        our $VERSION = sprintf q[%.3f], version->new(qw$Rev: 8 $)->numify / 1000;
...
=for svn $Id: BitTorrent.pm 8 2008-04-01 23:53:38Z sanko@cpan.org $
