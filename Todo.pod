...
=item * Verify complete callback system

=item * Define the direction the project will take in the future
...
=item * Improve handling of slow pieces
...
=item * very light gui example using perl/TK
...
=item * Full Multi-tracker spec compliance
...
=item * N::B::Lite - bare bones client (nowhere near ::Tiny)
...
=for svn $Id: Todo.pod 20 2008-05-22 23:09:05Z sanko@cpan.org $
